...
'use strict';
    ...
    $.fn.scrollmenu = function(options) {
		...
		defaultvalue._init = function(){
			...
			_this.selefoot = $('<div class="selefoot1"><div class="flex_between selefoot"><div id="secancel">取消</div><div id="seconfirm">确定</div></div></div>').appendTo(_this.cpt_selectScrollMenuContent);
			_this.cpt_ul_menuList = $('<ul class="cpt-ul-menuList"></ul>').appendTo(_this.selefoot);
