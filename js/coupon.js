...
//—————————————————————————————圆盘部分开始—————————————————————————————————
	...
	var notice = null;
	//转盘初始化
	var color = ["#FD6853","#FC8879","#FBF6B0","#ffffff","#ff4949","#FFE34A"];
	var info = ["公司注册","人事社保","代理记账","公司注册","公司注册","公司注册","公司注册","公司注册"];
	var info1 = ['¥150','¥150','¥150','¥150','¥150','¥150','¥150','¥150']
	var info2 = ['优惠券','满减券','代金券','优惠券','优惠券','优惠券','优惠券','优惠券'];
	canvasRun();
	...
	function probability(){
		...
		if ( num == 0 ) {
			...
			notice = info[0] + info1[0] + info2[0];
		}
		//概率
		else if ( num == 1 ) {
			angles = 2160 * rotNum + 1845;
			notice = info[7] + info1[7]+ info2[7];;
		}
		//概率
		else if ( num == 2 ) {
			angles = 2160 * rotNum + 1890;
			notice = info[6] + info1[6]+ info2[6];;
		}
		//概率
		else if ( num == 3 ) {
			angles = 2160 * rotNum + 1935;
			notice = info[5] + info1[5]+ info2[5];;
		}
		//概率
		else if ( num == 4 ) {
			angles = 2160 * rotNum + 1980;
			notice = info[4] + info1[4]+ info2[4];;
		}
		//概率
		else if ( num == 5 ) {
			angles = 2160 * rotNum + 2025;
			notice = info[3] + info1[3]+ info2[3];;
		}
		//概率
		else if ( num == 6 ) {
			angles = 2160 * rotNum + 2070;
			notice = info[2] + info1[2]+ info2[2];;
		}
		//概率
		else if ( num == 7 ) {
			angles = 2160 * rotNum + 2115;
			notice = info[1] + info1[1]+ info2[1];;
		}
	}
	...
	function canvasRun(){
	    ...
	    function createCirText(){	 
		    ...
		    for ( var i = 0; i < 8; i++) {
		        ...
		        ctx.fillStyle = color[3];
		        ctx.fillText(info[i],-30,-130,60);
		        ctx.font = " 14px Microsoft YaHei";
		        ctx.fillText(info1[i],-20,-107,60);
		        ctx.font = " 14px Microsoft YaHei";
		        ctx.fillText(info2[i],-24,-90,60);
		        ctx.closePath();
		        ctx.restore();
		    }
		}
